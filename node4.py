...
HOST_NAME = '0.0.0.0'
NODE_PORT = 5004 # Changed for Node 4
NODE_ID = "Hospital_4" # Changed for Node 4
NODE_PRIVATE_KEY = "Hospital_4_private_key" # Changed for Node 4
NODE_ENCRYPTION_KEY = "Hospital_4_ENC_Key" # Changed for Node 4
