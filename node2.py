# node2.py (Changes only NODE_PORT, NODE_ID, and the if NODE_ID == "Hospital_1" block)
...
HOST_NAME = '0.0.0.0'
NODE_PORT = 5002 # Changed from NODE1_PORT for generality
NODE_ID = "Hospital_2" # This node's unique identifier and public key
